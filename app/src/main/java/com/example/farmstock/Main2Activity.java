    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_slideshow:
                Toast.makeText(this, "Agricultural news", Toast.LENGTH_SHORT).show();
                fragment = new SlideshowFragment();
                toolbar.setTitle("Agricultural News");
                break;
            case R.id.nav_tools:
