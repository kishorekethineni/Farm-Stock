...
//        databaseReference = FirebaseDatabase.getInstance().getReference("User");
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(username)){
                    Toast.makeText(RegisterAcitivity.this, "Please enter your username", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(RegisterAcitivity.this, "Please enter your email", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(password)){
                    Toast.makeText(RegisterAcitivity.this, "Please enter your password", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(TextUtils.isEmpty(state)){
                    Toast.makeText(RegisterAcitivity.this, "Please select your state", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(username)||TextUtils.isEmpty(email)||TextUtils.isEmpty(password)||TextUtils.isEmpty(state)){
                    Toast.makeText(RegisterAcitivity.this, "Please fill all the fields!", Toast.LENGTH_SHORT).show();
                    return;

                }
                if(filePath==null){
                    Toast.makeText(RegisterAcitivity.this, "Please select profile photo", Toast.LENGTH_SHORT).show();
                    return;
                }
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    if(filePath!=null) {
                                        ...
                                        Toast.makeText(RegisterAcitivity.this, "Select profile picture", Toast.LENGTH_SHORT).show();
                                    }

                                } else {
                                    Toast.makeText(RegisterAcitivity.this, "Error: "+task.getException(), Toast.LENGTH_SHORT).show();
    ...
    private void Uploader(Uri pickedImgUri, final FirebaseUser currentUser, final String username, final String email, final String password, final String gender, final String state)
    {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(RegisterAcitivity.this, "You are successfully registered!", Toast.LENGTH_SHORT).show();
                                            progressDialog.dismiss();
                                            Intent i=new Intent(RegisterAcitivity.this,Main2Activity.class);
                                            startActivity(i);
                                            finish();
                                        }
