package com.example.farmstock.ui.home;
...
import com.example.farmstock.LoginActivity;
import com.example.farmstock.Main2Activity;
import com.example.farmstock.MainActivity;
import com.example.farmstock.R;
import com.example.farmstock.RegisterAcitivity;
import com.example.farmstock.UserData;
...
//        final TextView textView = root.findViewById(R.id.dashUserName);
...
//        EditText address=(EditText)root.findViewById(R.id.FullAddress);
        ...
        FirebaseDatabase.getInstance().getReference("User")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("City")
                .setValue(cityname);
        FirebaseDatabase.getInstance().getReference("User")
                .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("State")
                .setValue(state);
        FirebaseDatabase.getInstance().getReference("User")
    ...
    public void UpdateUi(){
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                address.setText("");
                statespin.setPrompt("select state");
                statespin.setPrompt(dataSnapshot.child("State").getValue().toString());
